...
const Login = ({email, setEmail, password, setPassword, name, setName, age, setAge, gender, setGender}) => {
    ...
    <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
        <a href="#" class="flex mt-3 items-center mb-6 text-2xl font-semibold text-gray-900 dark:text-white">
